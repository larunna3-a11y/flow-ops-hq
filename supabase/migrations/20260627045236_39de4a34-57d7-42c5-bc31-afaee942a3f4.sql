...
CREATE POLICY "packing_orders_select" ON public.packing_orders FOR SELECT TO authenticated USING (workspace_id = private.current_workspace_id());
...
CREATE POLICY "reports_select" ON public.reports FOR SELECT TO authenticated USING (workspace_id = private.current_workspace_id());
