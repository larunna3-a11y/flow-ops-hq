...
-- handle_new_user: supports both email and Google sign-ups.
-- Order: pending invitation match → join existing workspace with invited role.
-- Otherwise → create new workspace and assign Owner role.
